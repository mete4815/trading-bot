...
SYMBOL = "BTC/USDT"
COINS = ["PEPE/USDT", "SHIB/USDT", "FLOKI/USDT", "WIF/USDT", "BONK/USDT", "SOL/USDT", "AVAX/USDT", "NEAR/USDT", "APT/USDT", "SUI/USDT", "INJ/USDT", "TIA/USDT", "JUP/USDT", "PYTH/USDT", "RENDER/USDT"]
RISK_PERCENT = 2
...
def bot_calistir():
    ...
    while True:
        try:
            ...
            elif en_iyi_coin and en_iyi_skor >= -1:
